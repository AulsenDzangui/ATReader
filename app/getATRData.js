...
export const getATRData = (atrPath) => {
    return new Promise((resolve, reject) => {
        fs.readFile(atrPath, 'utf8', (err, data) => {
            ...
            const generalInfos = {
                ...
                ReplyCode: replyCode,
                GrantDate: grantDate,
                ArchivalAgency: archivalAgency === null || archivalAgency === void 0 ? void 0 : archivalAgency.trim(),
                TransferringAgency: transferringAgency === null || transferringAgency === void 0 ? void 0 : transferringAgency.trim(),
                LogBook: mainEvents
            };
            ...
            const ATRData = { generalInfos, archiveUnits, dataObjectGroups };
            resolve(ATRData);
        });
    });
};
