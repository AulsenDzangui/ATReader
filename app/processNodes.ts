export const getNodeTextContent = (elementsList: string | any[] | HTMLCollectionOf<Element>) => {
...
export const getAgencyIdentifierNodeTextContent = (elementsList: string | any[] | HTMLCollectionOf<Element>) => {
    for (let j = 0; j < elementsList.length; j++) {
        const element = elementsList[j];
...
export const getArchiveUnitDataOnATR = (archiveUnitsElementList: string | any[] | HTMLCollectionOf<Element>) => {
    const archiveUnits = [];
...
export const getDataObjectGroupOnATR = (elementsList: string | any[] | HTMLCollectionOf<Element>) => {
    ...
    for (let i = 0; i < elementsList.length; i++) {
        ...
        function getBinaries(binaryDataObjectElements: string | any[]) {
...
export const getEventsArray = (logBooksElementList: string | any[] | HTMLCollectionOf<Element>, isMain = false) => {
    const eventsList = [];
...
export const getSubElementsList = (parentElementList: string | any[]) => {
