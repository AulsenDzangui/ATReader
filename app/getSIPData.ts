...
import { SIPData } from './types.js';


export const getSIPData = (manifestPath: fs.PathOrFileDescriptor): Promise<SIPData> => {
    ...
    return new Promise((resolve, reject) => {
        fs.readFile(manifestPath, 'utf8', (err, data) => {
            ...
            function isFile(archiveUnit: XMLElement): boolean {
            ...
            const SIPData: SIPData = { generalInfos, archiveUnits, dataObjectGroups };
