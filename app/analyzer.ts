...
export const analyzer = async (req: any, res: any) => {
    ...
    uploadFiles(req, res, async function (err) {
        ...
        await _analyzer(req, res)
    })
}

const _analyzer = async (req: any, res: any) => {
    ...
    try {
        const { atrFile, manifestFile }:any = await getFileAfterValidation(req, res);
        ...
        const ATRData = await getATRData(atrPath);
        const SIPData = await getSIPData(manifestPath);
